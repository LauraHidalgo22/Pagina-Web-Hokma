...
const Footer = () => {
  return (
    <footer className="relative bg-gradient-to-br from-[#292C3A] via-[#3a3f52] to-[#292C3A] text-white py-12 overflow-hidden">
      {/* Background Effects */}
      <div className="absolute inset-0 bg-gradient-to-r from-[#292C3A]/20 to-[#3a3f52]/20"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
          ...
          >
            <div>
              ...
              />
              <p className="text-gray-300 text-sm leading-relaxed" style={{ fontFamily: 'Caviar Dreams' }}>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <span className="text-gray-300 text-sm" style={{ fontFamily: 'Caviar Dreams' }}>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300 text-sm" style={{ fontFamily: 'Caviar Dreams' }}>Tel: 601 794 6566</span>
              </div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-gray-200 transition-colors duration-300 transform hover:scale-110">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-2 md:mt-0">
              <a href="#" className="text-gray-400 hover:text-gray-200 text-xs transition-colors duration-300" style={{ fontFamily: 'Caviar Dreams' }}>
