        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              >
                Bogotá, Colombia<br />
                Estamos expandiendo nuestras ubicaciones
              </p>
            </div>
            ...
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
              ...
              <p 
                ...
                style={{ fontFamily: 'Caviar Dreams' }}
              >
                Estamos explorando nuevas ubicaciones para estar más cerca de ti. 
          ...
          <div className="text-center pt-4">
            <a 
              ...
              className="inline-flex items-center px-6 py-3 rounded-full text-white font-medium transition-all duration-300 hover:scale-105"
              style={{ 
