    ...
    <CustomProvider>
      ...
      <div className="fixed bottom-6 right-6 z-50 group">
        <a 
          ...
          className="flex items-center bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 overflow-hidden"
        >
          {/* WhatsApp Icon */}
          <div className="p-4">
            <svg 
